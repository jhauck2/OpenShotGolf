...
func _input(event: InputEvent) -> void:
	...
	var selector_rect : Rect2 = get_global_rect()
	var is_over_selector : bool = selector_rect.has_point(global_mouse_pos)
...
func _create_club_buttons() -> void:
	var button_theme : Theme = _create_club_button_theme()
...
func _create_club_button_theme() -> Theme:
	...
	var normal_style : StyleBox = _create_button_style(BUTTON_BG_NORMAL)
	button_theme.set_stylebox("normal", "Button", normal_style)

	var hover_style : StyleBox = _create_button_style(BUTTON_BG_HOVER)
	button_theme.set_stylebox("hover", "Button", hover_style)

	var pressed_style : StyleBox = _create_button_style(BUTTON_BG_PRESSED)
...
func _set_button_selected(button: Button) -> void:
	...
	var selected_style : StyleBoxFlat = _create_selected_button_style()
